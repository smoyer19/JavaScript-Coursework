//This variablel keeps track of whose turn it is.
let activePlayer = "X";
//This array stores an array of moves. We use this to determine win conditions.
let selectedSquares = [];

//This function is for placing an x or o in asquare.
function placeXOrO(squareNumber) {
    //This condition ensures a square hasn't been selected already. 
    //the .some() method is used to check each element of selectedSquare array
    //to see if it contains the square njumber clicked on.
...
function computersTurn() {
    ...
    //trying if a sqyare is selected already.
    while(!success) {
...
function arrayIncludes(squareA, squareB, squareC) {
    ...
    // If the 3 variables we pass are all included iin our array true is
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    let x1 = coordX1,
        //This line iindicates where the start of a lines y axis is.
        y1 = coordY1,
    ...
    function animateLineDrawing() {
        ...
        c.stroke();
        //This conditionchecks if we've reached the endpoint.
        if (x1 <= x2 && y1 <= y2) {
            //This condition adds 10 to the preveious end x point.
            if (x < x2) { x += 10; }
...
function resetGame() {
    //This for loop iterates through eaach HTML square element
    for (let i = 0; i < 9; i++) {
